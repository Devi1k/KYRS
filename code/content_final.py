...
typedict = {'user_id': int, 'content_id': int, 'desc': object, 'topic_id': int, 'genre_id': int,
            ...
            'created_at': int}
val = pd.read_csv('../dataset/content.txt', sep='\t', encoding='utf-8', dtype=typedict)
